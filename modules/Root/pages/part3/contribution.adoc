...
link:../part1/running.md#from-pre-packaged-distribution[release-artifacts for Linux, MacOS and Windows for each supported Node.js version]
...
detailed in the Juice Shop's https://github.com/juice-shop/juice-shop/blob/master/CODE_OF_CONDUCT.md[Code of Conduct].

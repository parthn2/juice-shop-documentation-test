...
https://github.com/juice-shop/juice-shop/blob/master/REFERENCES.md[references compilation on GitHub]?
...
You can provide feedback on all solved xref:../part1/challenges.adoc[hacking] and link:../part1/challenges.md#coding-challenges[coding challenges] directly from the
link:../part1/challenges.md#the-score-board[Score Board] and Coding Challenge modal dialog. Clicking the respective like/dislike button

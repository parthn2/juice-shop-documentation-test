...
* Solving the
link:injection.md#order-the-christmas-special-offer-of-2014[Order the Christmas special offer of 2014]
...
link:broken-authentication.md#log-in-with-the-administrators-user-credentials-without-previously-changing-them-or-applying-sql-injection[Log in with the administrators user credentials without previously changing them or applying SQL Injection]

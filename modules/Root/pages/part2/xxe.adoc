...
link:security-misconfiguration.md#use-a-deprecated-b2b-interface-that-was-not-properly-shut-down[Use a deprecated B2B interface that was not properly shut down].
...
Similar to
link:injection.md#let-the-server-sleep-for-some-time[Let the server sleep for some time]

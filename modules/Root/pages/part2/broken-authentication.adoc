...
link:injection.md#retrieve-a-list-of-all-user-credentials-via-sql-injection[Retrieve a list of all user credentials via SQL Injection]
...
link:injection.md#log-in-with-the-administrators-user-account[Log in with the administrator's user account]

...
link:miscellaneous.md#read-our-privacy-policy[Read our privacy policy].
...
uncovered in
link:cryptographic-issues.md#apply-some-advanced-cryptanalysis-to-find-the-real-easter-egg[Apply some advanced cryptanalysis to find the real easter egg].

...
link:../appendix/trainers.md#challenges-for-demos[challenges which are suitable for live demos]
...
The link:running.md#self-healing-feature[_self-healing_ feature] - by
...
link:../part2/score-board.md#find-the-carefully-hidden-score-board-page[Find the carefully hidden 'Score Board' page].
...
link:customization.md#yaml-configuration-file[YAML configuration file].

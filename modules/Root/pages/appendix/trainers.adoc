...
There are multiple link:../part1/running.md#run-options[Run Options] which
...
link:../part1/customization.md#additional-browser-tweaks[Additional Browser tweaks].
...
Another helpful feature for the trainer MultiJuicer is the https://github.com/iteratec/multi-juicer/blob/master/guides/monitoring-setup/monitoring.md[optional
...
https://github.com/juice-shop/juice-shop/blob/master/REFERENCES.md#lectures-and-trainings[Lectures and Trainings section]
...
the
link:../part2/score-board.md#find-the-carefully-hidden-score-board-page[Score Board]
...
| link:../part2/xss.md#perform-a-dom-xss-attack[DOM XSS]
| XSS
| ⭐
| ⏳
| None

| link:../part2/sensitive-data-exposure.md#access-a-confidential-document[Confidential Document]
| Sensitive Data Exposure
| ⭐
| ⏳
| None

| link:../part2/injection.md#log-in-with-the-administrators-user-account[Login Admin]
| Injection
| ⭐⭐
| ⏳
| None

| link:../part2/miscellaneous.md#read-our-privacy-policy[Privacy Policy]
| Miscellaneous
| ⭐
| ⏳
| Log in as any user

| link:../part2/xss.md#perform-a-reflected-xss-attack[Reflected XSS]
| XSS
| ⭐⭐
| ⏳⏳
| Log in as any user and complete checkout process (to find the vulnerable tracking link)

| link:../part2/security-through-obscurity.md#prove-that-you-actually-read-our-privacy-policy[Privacy Policy Inspection]
| Security through Obscurity
| ⭐⭐⭐
| ⏳⏳
| link:../part2/miscellaneous.md#read-our-privacy-policy[Privacy Policy]

| link:../part2/broken-access-control.md#access-the-administration-section-of-the-store[Admin Section]
| Broken Access Control
| ⭐⭐
| ⏳⏳
| link:../part2/injection.md#log-in-with-the-administrators-user-account[Login Admin] or link:../part2/improper-input-validation.md#register-as-a-user-with-administrator-privileges[Admin Registration]

| link:../part2/broken-access-control.md#view-another-users-shopping-basket[View Basket]
| Broken Access Control
| ⭐⭐
| ⏳⏳
| Log in with two different users

| link:../part2/broken-access-control.md#find-the-hidden-easter-egg[Easter Egg]
| Broken Access Control
| ⭐⭐⭐⭐
| ⏳⏳⏳
| Explain _Poison Null Byte_

| link:../part2/cryptographic-issues.md#apply-some-advanced-cryptanalysis-to-find-the-real-easter-egg[Nested Easter Egg]
| Cryptographic Issues
| ⭐⭐⭐⭐
| ⏳⏳⏳
| link:../part2/broken-access-control.md#find-the-hidden-easter-egg[Easter Egg]

| link:../part2/sensitive-data-exposure.md#access-a-developers-forgotten-backup-file[Forgotten Developer Backup]
| Sensitive Data Exposure
| ⭐⭐⭐⭐
| ⏳⏳⏳
| Explain _Poison Null Byte_

| link:../part2/cryptographic-issues.md#forge-a-coupon-code-that-gives-you-a-discount-of-at-least-80[Forged Coupon]
| Cryptographic Issues
| ⭐⭐⭐⭐⭐⭐
| ⏳⏳⏳⏳
| link:../part2/sensitive-data-exposure.md#access-a-developers-forgotten-backup-file[Forgotten Developer Backup] and `z85-cli` installed *or* link:../part2/sensitive-data-exposure.md#access-a-salesmans-forgotten-backup-file[Forgotten Sales Backup] *or* tracing coupons from Twitter back to https://github.com/juice-shop/juicy-coupon-bot/actions?query=workflow%3A%22Monthly+Coupon+Distribution%22
|===

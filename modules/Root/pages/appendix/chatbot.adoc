...
link:../part2/miscellaneous.md#receive-a-coupon-code-from-the-support-chatbot[Receive a coupon code from the support chatbot]
...
link:troubleshooting.md#start-up-validations[Start-up validations]. To

...
| Install one of the officially supported Node.js versions {nodeVersions}. If you use a link:../part1/running.md#from-pre-packaged-distribution[pre-packaged distribution], make sure its version matches your installed Node.js version.

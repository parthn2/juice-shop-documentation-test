...
"link:../part2/sensitive-data-exposure.md#find-the-endpoint-that-serves-usage-data-to-be-scraped-by-a-popular-monitoring-system[Find the endpoint that serves usage data to be scraped by a popular monitoring system]".
...
link:trainers.md#hosting-individual-instances-for-multiple-users[MultiJuicer],
